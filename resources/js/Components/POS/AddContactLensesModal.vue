                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                Trouvez la lentille exacte correspondant aux
                    ...
                    <div class="mb-8">
                        ...
                        >
                            ...
                            >
                                📋 Étape 1 : Marque et Modèle
                            </h4>
                            <p class="text-xs text-blue-700">
                                Sélectionnez d'abord la famille de lentilles que
                                porte le client
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div
                                    v-else
                                    class="p-3 bg-gray-50 border border-gray-200 rounded-md text-center text-gray-500 text-sm"
                                >
                        ...
                        <div
                            v-if="filteredModels.length > 0 && !selectedModel"
                            class="mt-4"
                        >
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="silicone_hydrogel">
                                        Silicone hydrogel
                                    </option>
                        ...
                        <div
                            v-if="
                                form.description && form.price && form.quantity
                            "
                        ...
                        >
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                ...
                                <p v-if="form.brand">
                                    <strong>Marque:</strong> {{ form.brand }}
                                </p>
                                <div
                                    v-if="
                                        form.powerOd !== null ||
                                ...
                                >
                                    ...
                                    <span v-if="form.powerOd !== null"
                                        >OD: {{ form.powerOd >= 0 ? "+" : ""
                                        }}{{ form.powerOd }}</span
                                    >
                                    <span
                                        v-if="form.powerOg !== null"
                                        class="ml-2"
                                        >OG: {{ form.powerOg >= 0 ? "+" : ""
                                        }}{{ form.powerOg }}</span
                                    >
                                </div>
                                <p v-if="form.lensType">
                                    <strong>Type:</strong>
                                    {{ getLensTypeLabel(form.lensType) }}
                                </p>
                                <p>
                                    <strong>Total:</strong>
                                    {{
                                        formatPrice(form.price * form.quantity)
                                    }}
                                </p>
                            </div>
                        </div>
