        ...
        >
            ...
            >
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-6">
                        ...
                        >
                            ...
                            <p class="text-xs text-blue-700">
                                Permet d'afficher dynamiquement les bons champs
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            ...
                            >
                                ...
                                <div class="flex items-center">
                                    <div
                                        class="w-4 h-4 border-2 rounded-full mr-3"
                                        :class="
                                            form.lensType === type.value
                    ...
                    <div class="mb-6">
                        <div
                            class="bg-green-50 rounded-lg p-4 border border-green-200 mb-4"
                        >
                            <h4
                            ...
                            <p class="text-xs text-green-700">
                                L'opticien choisit pour quel(s) œil(s) il
                                configure les lentilles
                            </p>
                        </div>
                    ...
                    <div
                        v-if="
                            form.lensType && (form.includeOD || form.includeOG)
                        "
                        class="mb-6"
                    >
                        <div
                            class="bg-purple-50 rounded-lg p-4 border border-purple-200 mb-4"
                        >
                            <h4
                                class="text-sm font-semibold text-purple-900 mb-2"
                            >
                                🔹 3. Paramètres techniques par œil
                            </h4>
                            <p class="text-xs text-purple-700">
                                S'adaptent dynamiquement au type de lentille
                                choisi
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <h5
                                        class="text-sm font-semibold text-blue-900 flex items-center"
                                    >
                                        <span
                                            class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs mr-2"
                                            >OD</span
                                        >
                                        Œil Droit
                                    </h5>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div
                                        v-if="form.lensType === 'multifocale'"
                                        class="grid grid-cols-2 gap-3"
                                    >
                                        <div>
                                            <label
                            ...
                            >
                                <h5
                                    class="text-sm font-semibold text-purple-900 mb-4 flex items-center"
                                >
                                    <span
                                        class="w-6 h-6 bg-purple-600 text-white rounded-full flex items-center justify-center text-xs mr-2"
                                        >OG</span
                                    >
                                    Œil Gauche
                                </h5>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div>
                                            <label
                                                class="block text-xs font-medium text-purple-800 mb-1"
                                                >Sphère (SPH) *</label
                                            >
                                            <input
                    ...
                    <div v-if="hasValidParameters" class="mb-6">
                        <div
                            class="bg-orange-50 rounded-lg p-4 border border-orange-200 mb-4"
                        >
                            <h4
                                class="text-sm font-semibold text-orange-900 mb-2"
                            >
                                🔹 4. Produit et Marque
                            </h4>
                            <p class="text-xs text-orange-700">
                                Pour choisir le modèle spécifique disponible en
                                magasin
                            </p>
                        </div>
                    ...
                    <div v-if="hasValidParameters" class="mb-6">
                        <div
                            class="bg-yellow-50 rounded-lg p-4 border border-yellow-200 mb-4"
                        >
                            <h4
                                class="text-sm font-semibold text-yellow-900 mb-2"
                            >
                                🔹 5. Quantité
                            </h4>
                            <p class="text-xs text-yellow-700">
                                Nombre de boîtes pour chaque œil
                            </p>
                        </div>
                    ...
                    <div v-if="hasValidParameters" class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                >
                                <div
                                    class="px-3 py-2 bg-green-100 border border-green-300 rounded-md text-green-900 font-bold"
                                >
                    ...
                    <div v-if="hasValidParameters" class="mb-6">
                        ...
                        >
                            ...
                            <p class="text-xs text-gray-700">
                                Champ libre pour que l'opticien ajoute une note
                            </p>
                        </div>
...
const hasValidParameters = computed(() => {
    return (
        form.value.lensType && (form.value.includeOD || form.value.includeOG)
    );
});

const totalHT = computed(() => {
    const totalQuantity =
        (form.value.quantityOD || 0) + (form.value.quantityOG || 0);
...
const canAddToCart = computed(() => {
    return (
        hasValidParameters.value &&
        form.value.unitPrice > 0 &&
        (form.value.quantityOD || 0) + (form.value.quantityOG || 0) > 0 &&
        ((form.value.includeOD &&
            form.value.od.sphere !== null &&
            form.value.od.bc !== null) ||
            (form.value.includeOG &&
                form.value.og.sphere !== null &&
                form.value.og.bc !== null))
    );
});
...
const calculatePrice = async () => {
    ...
    try {
        ...
        if (form.value.includeOD) {
            if (form.value.od.sphere !== null)
                parameters.sphere = form.value.od.sphere;
            if (form.value.od.cylinder !== null)
                parameters.cylinder = form.value.od.cylinder;
            if (form.value.od.addition !== null)
                parameters.addition = form.value.od.addition;
        } else if (form.value.includeOG) {
            if (form.value.og.sphere !== null)
                parameters.sphere = form.value.og.sphere;
            if (form.value.og.cylinder !== null)
                parameters.cylinder = form.value.og.cylinder;
            if (form.value.og.addition !== null)
                parameters.addition = form.value.og.addition;
        }

        const response = await axios.post(
            "/api/contact-lens-prices/calculate",
            {
    ...
    searchTimeout.value = setTimeout(async () => {
        ...
        try {
            const response = await axios.get(
                "/api/contact-lens-brands/search",
                {
...
const loadPopularBrands = async () => {
    try {
        ...
        console.error(
            "Erreur lors du chargement des marques populaires:",
            error
        );
    }
};
