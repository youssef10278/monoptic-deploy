        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div v-else-if="hasAlerts" class="space-y-3">
                ...
                <div v-if="lowStockProducts && lowStockProducts.length > 0">
                    <h4
                        class="text-sm font-medium text-yellow-800 mb-2 flex items-center"
                    >
                        <svg
                            class="h-4 w-4 mr-1"
                            fill="none"
                        ...
                        >
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0">
                                    ...
                                    >
                                        <span
                                            class="text-xs font-bold text-yellow-800"
                            ...
                            <div class="text-right">
                                <div
                                    ...
                                    :class="
                                        getStockLevelClass(product.quantity)
                                    "
                                >
                                    Stock: {{ product.quantity }}
                                </div>
...
const hasAlerts = computed(
    () => lowStockCount.value > 0 || outOfStockCount.value > 0
);
