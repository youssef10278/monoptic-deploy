    ...
    <div class="space-y-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    {{
                                        dashboardData?.kpis?.expired_tenants ||
                                        0
                                    }}
                                </dd>
                            </dl>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div
                    v-else-if="dashboardData?.tenants?.length === 0"
                ...
                >
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Aucun magasin n'est encore enregistré sur la plateforme.
                    </p>
                </div>

                <div
                    v-else-if="dashboardData && dashboardData.tenants"
                ...
                >
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr
                                v-for="tenant in dashboardData.tenants"
                                :key="tenant.id"
...
const loadDashboardData = async () => {
    ...
    try {
        ...
        if (error.response?.status === 403) {
            errorMessage.value =
                "Accès refusé. Vous devez être Super Administrateur pour accéder à cette page.";
        } else {
            errorMessage.value =
